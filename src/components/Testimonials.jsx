        ...
        <div className='mt-8 lg:mt-12 relative'>
          ...
          >
            {reviews.map((review) => (
              <SwiperSlide key={review.id}>
                <div className='relative flex flex-col items-center lg:pb-28 '>
                  <div className=''>
                    <img
                  ...
                  <div className='absolute top-0 left-6 border-2 border-[#2B74B8] rounded-full p-0.5 h-8 w-8'>
                    <img
                      ...
                      src='https://clippingpathca.com/wp-content/uploads/2024/08/clint2.png'
                      alt='Sam Altman'
                    />
                  </div>
                  <div className='absolute top-12 right-6 hidden lg:block lg:right-0 border-2 border-secondary rounded-full p-0.5 h-10 w-10'>
                    <img
                      className='rounded-full'
                      src='https://clippingpathca.com/wp-content/uploads/2024/08/client.png'
                      alt='Sam Altman'
                    />
                  </div>
                </div>
          ...
          <div className='absolute top-44 lg:top-64 left-0 lg:left-16 xl:left-40'>
            <button
              ...
              className='!cursor-pointer p-4 flex z-10 hover:!bg-transparent focus:!bg-transparent !border-none hover:!border-none'
            >
          ...
          <div className='absolute top-44 lg:top-64 right-0 lg:right-16 xl:right-40'>
            <button
              ...
              className='!cursor-pointer p-4 flex z-10 hover:!bg-transparent !border-none focus:!bg-transparent hover:!border-none'
            >
